...
| --------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| `rag-eval`      | draft  | LLM-as-judge eval: per-fact recall/precision, per-`doc_id` faithfulness, `None` abstention, judge determinism, retrieval metric aggregation, abstention scoring (empty-gold predicate + two-layer gate/generator), cassette/replay (ADR-0006) | `kb-architect` |
