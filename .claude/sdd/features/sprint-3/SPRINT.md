...
| Phase | Intent                                                                                                                                                                                                                                               | Slug                       |
| ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| 7     | Tracing: stand up self-hosted Langfuse (docker-compose); an exporter replays the Phase 6 eval JSONL into it as OTEL-GenAI span trees (deterministic score IDs as idempotency keys). **Accept ADR-0004** by validating against the running deployment | `phase-7-tracing`          |
